						...
						for blocksize_k in [32, 64, 128]:
							benchmark_configs.append(
								triton.testing.Benchmark(
									...
									ylabel="MS",
									plot_name=f"batch_size={batch_size}-bias={bias}-headdim={headdim}-num_q_heads={num_heads*2}-num_kv_heads={num_heads}-blocksize_q={blocksize_q}-blocksize_k={blocksize_k}-mode={mode}",
									args={
										"BATCH": batch_size,
										"QH": num_heads * 2,
										"KH": num_heads,
...
if __name__ == "__main__":
	mha_attention_benchmark.run(
		print_data=True,
		save_path="jax-flash-attn2/benchmarks/gqa/triton",
	)
